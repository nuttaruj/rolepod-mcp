...
export const browserScreenshotTool: ToolModule<typeof browserScreenshotShape> = {
  ...
  description:
    "Capture a screenshot and save under ./.rolepod-mcp/artifacts/{run_id}/. Set `full_page: true` for full-page capture; default is viewport only. Read-only (does NOT invalidate refs).",
